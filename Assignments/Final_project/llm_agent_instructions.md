...
Create a file in `.github/instructions/collaboration.instructions.md`

For reference: https://code.visualstudio.com/docs/copilot/customization/custom-instructions#_type-of-instructions-files

Some of these instructions will not apply to you depending on your role, but please read all in detail.

I suggest you copy-paste the following template into that file and modify it as needed.

A large focus on this is to make a dev plan, however you can adapt this to simply make code changes instead of a full plan if that is more appropriate.
